...
Here are the step-by-step instructions required to use network upload to bulk-import multiple PST files to Office 365 mailboxes.
  
[Step 1: Copy the SAS URL and install Azure AzCopy](use-network-upload-to-import-pst-files.md#step1)
  
[Step 2: Upload your PST files to Office 365](use-network-upload-to-import-pst-files.md#step2)
  
[(Optional) Step 3: View a list of the PST files uploaded to Office 365](use-network-upload-to-import-pst-files.md#step3)
  
[Step 4: Create the PST Import mapping file](use-network-upload-to-import-pst-files.md#step4)
  
[Step 5: Create a PST Import job in Office 365](use-network-upload-to-import-pst-files.md#step5)
  
[Step 6: Filter data and start the PST Import job](use-network-upload-to-import-pst-files.md#step6)
...
Please see the **Before you begin** tab to learn about the prerequisites required to import PST files using the network upload method. 
...
2. In step 3, click **Download Azure AzCopy** to download and install the Azure AzCopy tool. As previously stated, version 7.1.0 will be downloaded. 
...
7. You can leave the **Import data** page open (in case you need to copy the SAS URL again) or click **Cancel** to close it. 
    
[Return to top](use-network-upload-to-import-pst-files.md#instructions_top)
...
- In an Exchange hybrid deployment, you can import PST files to a cloud-based archive mailbox for a user whose primary mailbox is on-premises. You do this by doing the following in the PST Import mapping file:
  ...
  - Specify the **TRUE** value in the  `IsArchive` parameter. 
    ...
    See Step 4 on the **Instructions** tab in this topic for more information. 
...
[Return to top](use-network-upload-to-import-pst-files.md#byb_top)
...
[Return to top](use-network-upload-to-import-pst-files.md#howitworks_top)
...
[Return to top](use-network-upload-to-import-pst-files.md#moreinformation_top)
  
## [FAQs](#tab/)
  
Here are some frequently asked questions about using network upload to bulk-import PST files to Office 365 mailboxes.
...
[Return to top](use-network-upload-to-import-pst-files.md#FAQtop)
  
## [Send feedback](#tab/)
  
Using the Import service in Office 365 is a powerful, effective way to bulk-import PST files to large numbers of user mailboxes. But we know that having to use a command-line tool and CSV file is complex and time-consuming. We're working on a more modern experience that makes this process easier. Until then, we hope the detailed instructions in this topic will help you successfully import your organization's PST files to Office 365. We'd love to hear your ideas on how we can make the PST import process more modern. The best way to do this is to leave feedback directly on the **Import** page in the Security &amp; Compliance Center. Just look for the **Feedback** tool on the bottom right of the page. 
