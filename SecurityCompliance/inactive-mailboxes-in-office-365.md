...
[What are inactive mailboxes?](inactive-mailboxes-in-office-365.md#whatare)
  
[Inactive mailboxes and Office 365 retention policies](inactive-mailboxes-in-office-365.md#O365retentionpolicies)
  
[Inactive mailboxes and eDiscovery case holds](inactive-mailboxes-in-office-365.md#ediscoverycaseholds)
  
[Inactive mailboxes and Office 365 labels](inactive-mailboxes-in-office-365.md#labels)
  
[Inactive mailboxes and Exchange MRM retention policies](inactive-mailboxes-in-office-365.md#MRMretentionpolicies)
  
[Creating an inactive mailbox](inactive-mailboxes-in-office-365.md#creating)
  
[Managing inactive mailboxes](inactive-mailboxes-in-office-365.md#managing)
...
[Return to top](inactive-mailboxes-in-office-365.md#top)
  
## Inactive mailboxes and Office 365 retention policies
<a name="O365retentionpolicies"> </a>
...
- It has to be configured to retain content or retain and then deleted content. If a retention policy is configured to just delete content, a mailbox that the policy is applied to won't become inactive when the mailbox is deleted.
...
- It's an easy way to identify inactive mailboxes because the retention policy will only be applied to inactive mailboxes.
...
For more information about eDiscovery cases and holds, see [Manage eDiscovery cases in the Office 365 Security &amp; Compliance Center](manage-ediscovery-cases.md).
...
> [!NOTE]
> If a Litigation Hold is already placed on a mailbox, or if an Office 365 retention policy is already applied to it, then all you have to do is delete the corresponding Office 365 user account to create an inactive mailbox. 
