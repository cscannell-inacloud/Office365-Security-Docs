...
1. [Review the prerequisites](set-up-atp-anti-phishing-policies.md#phishprereq)
    
2. [Learn about ATP anti-phishing policy options](set-up-atp-anti-phishing-policies.md#phishpolicyoptions)
    
3. [Set up an ATP anti-phishing policy](set-up-atp-anti-phishing-policies.md#addphishpolicy)
...
5. Specify the name, description, and settings for your policy. See [Learn about ATP anti-phishing policy options](set-up-atp-anti-phishing-policies.md#phishpolicyoptions) for more details. 
