...
This topic includes scripts that you can run to create, start, report on, and delete multiple searches. Here's an overview of the process:
  
[Step 1: Create a CSV file that contains information about the searches you want to run](create-report-on-and-delete-multiple-content-searches.md#step1)
  
[Step 2: Connect to the Security &amp; Compliance Center using Remote PowerShell](create-report-on-and-delete-multiple-content-searches.md#step2)
  
[Step 3: Run the script to create and start the searches](create-report-on-and-delete-multiple-content-searches.md#step3)
  
[Step 4: Run the script to report the search estimates](create-report-on-and-delete-multiple-content-searches.md#step4)
  
[Step 5: Run the script to delete the searches](create-report-on-and-delete-multiple-content-searches.md#step5)
...
[Return to top](create-report-on-and-delete-multiple-content-searches.md#top)
