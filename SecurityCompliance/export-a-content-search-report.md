...
6. On the **Export a report** page, under **Include these items from the search**, choose one of the following options:
  ...
  - Export only unindexed items
    ...
    For more information about unindexed items, see [Unindexed items in Content Search](partially-indexed-items-in-content-search.md).
...
[Return to top](export-a-content-search-report.md#top)
