...
See the [More information](restore-an-inactive-mailbox.md#moreinfo) section for more details about the differences between restoring and recovering an inactive mailbox. 
...
[Return to top](restore-an-inactive-mailbox.md#top)
